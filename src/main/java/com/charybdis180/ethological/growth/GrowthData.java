...
public record GrowthData(long birthGameTime, long growUpGameTime, float initialScale, float targetScale) {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, GrowthData> STREAM_CODEC = StreamCodec.composite((StreamCodec)ByteBufCodecs.VAR_LONG, GrowthData::birthGameTime, (StreamCodec)ByteBufCodecs.VAR_LONG, GrowthData::growUpGameTime, (StreamCodec)ByteBufCodecs.FLOAT, GrowthData::initialScale, (StreamCodec)ByteBufCodecs.FLOAT, GrowthData::targetScale, GrowthData::new);
}
