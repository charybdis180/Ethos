...
extends SleepingPigModel {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 15).addBox(-3.5f, -5.0f, -5.0f, 7.0f, 6.0f, 6.0f, new CubeDeformation(0.025f)).texOffs(6, 27).addBox(-1.5f, -1.975f, -6.0f, 3.0f, 2.0f, 1.0f, new CubeDeformation(0.015f)), PartPose.offset((float)0.0f, (float)19.0f, (float)-2.0f));
        partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(-3.5f, -3.0f, -4.5f, 7.0f, 6.0f, 9.0f, new CubeDeformation(0.0f)), PartPose.offset((float)0.0f, (float)19.0f, (float)0.5f));
        partdefinition.addOrReplaceChild("left_hind_leg", CubeListBuilder.create().texOffs(0, 4).addBox(-1.0f, 0.0f, -1.0f, 2.0f, 2.0f, 2.0f, new CubeDeformation(0.0f)), PartPose.offset((float)2.5f, (float)22.0f, (float)4.0f));
        partdefinition.addOrReplaceChild("right_hind_leg", CubeListBuilder.create().texOffs(23, 4).addBox(-1.0f, 0.0f, -1.0f, 2.0f, 2.0f, 2.0f, new CubeDeformation(0.0f)), PartPose.offset((float)-2.5f, (float)22.0f, (float)4.0f));
        partdefinition.addOrReplaceChild("left_front_leg", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0f, 0.0f, -1.0f, 2.0f, 2.0f, 2.0f, new CubeDeformation(0.0f)), PartPose.offset((float)2.5f, (float)22.0f, (float)-3.0f));
        partdefinition.addOrReplaceChild("right_front_leg", CubeListBuilder.create().texOffs(23, 0).addBox(-1.0f, 0.0f, -1.0f, 2.0f, 2.0f, 2.0f, new CubeDeformation(0.0f)), PartPose.offset((float)-2.5f, (float)22.0f, (float)-3.0f));
    ...
    public void setupAnim(Pig entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (asleep) {
            ...
            this.body.yRot = 0.0f;
            this.body.zRot = 0.0f;
            SleepPose.apply(this.parts, 21.0f, 23.0f, -2.0f, 3.0f, this.defaultRightFrontX, this.defaultLeftFrontX, this.defaultRightHindX, this.defaultLeftHindX, 0.5f, 1.0f, resting, this.defaultBodyY, this.defaultHeadY);
        } else {
            this.body.y = this.defaultBodyY;
            this.head.y = this.defaultHeadY;
            this.head.z = this.defaultHeadZ;
            SleepPose.clear(this.parts, this.defaultBodyY, this.defaultHeadY, 22.0f, this.defaultFrontLegZ, this.defaultHindLegZ, this.defaultRightFrontX, this.defaultLeftFrontX, this.defaultRightHindX, this.defaultLeftHindX);
